...
image: /assets/images/misc/apollo8-dome.webp
image-alt: Audience in a dome theater watching an OpenSpace visualization of the Moon
format:
  html:
    page-layout: full
    toc: false
    anchor-sections: false
    theme: ../assets/style/page/about.scss
...
![](/assets/images/misc/apollo8-dome.webp){.page-about__media fig-alt="Audience in a dome theater watching an OpenSpace visualization of the Moon"}
...
![](/assets/images/misc/2015-02-19.webp){.page-about__media fig-alt="Early OpenSpace software rendering from February 2015"}
...
![](/assets/images/misc/dome-terrain.webp){.page-about__media--full fig-alt="Fisheye dome projection of mountainous terrain rendered in OpenSpace"}
