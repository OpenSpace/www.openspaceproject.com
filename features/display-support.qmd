...
![](/assets/images/venue-cards/hayden_jwst.webp){.page-display-support__img fig-alt="Hayden Planetarium dome running OpenSpace with JWST data"}
...
![](/assets/images/venue-cards/amnh_lwd_students.webp){.page-display-support__img fig-alt="Students using OpenSpace in a classroom at AMNH"}
...
![](/assets/images/venue-cards/spaceship.webp){.page-display-support__img fig-alt="OpenSpace running in a museum exhibit"}
...
```{=html}
<video class="page-display-support__img" autoplay loop muted playsinline>
