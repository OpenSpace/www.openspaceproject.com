...
![](/assets/images/venue-cards/hayden_jwst.webp){.page-displaysupport-img fig-alt="Hayden Planetarium dome running OpenSpace with JWST data"}

::: {.page-displaysupport-body}
...
![](/assets/images/venue-cards/amnh_lwd_students.webp){.page-displaysupport-img fig-alt="Students using OpenSpace in a classroom at AMNH"}
...
![](/assets/images/venue-cards/spaceship.webp){.page-displaysupport-img fig-alt="OpenSpace running in a museum exhibit"}
...
```{=html}
<video class="page-displaysupport-img" autoplay loop muted playsinline>
